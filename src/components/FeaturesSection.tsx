  ...
  return (
    <section className="lg:px-28 sm:px-8 px-4 lg:py-14 py-20 bg-[#F7F7F7]">
      <div className="container mx-auto">
        <div className="my-8 grid grid-cols-6 gap-8 [&>div:nth-child(1):hover]:bg-black [&>div:nth-child(1):hover]:text-white [&>div:nth-child(1):hover>div>div>img]:block [&>div:nth-child(2)>div>div>img:hover]:rotate-[23deg] [&>div:nth-child(2)>div>div>img:hover]:-bottom-5 [&>div:nth-child(2)>div>div>img:hover]:-right-16 [&>div:nth-child(3)]:bg-black [&>div:nth-child(3)]:text-white [&>div:nth-child(3):hover]:bg-white [&>div:nth-child(3):hover]:text-black [&>div:nth-child(3):hover>div>div>img]:block [&>div:nth-child(4)]:bg-black [&>div:nth-child(4)]:text-white [&>div:nth-child(4):hover]:bg-white [&>div:nth-child(4):hover]:text-black [&>div:nth-child(4):hover>div>div>img]:block">
                ...
                <div className="px-4 mt-4">
                  ...
                  <div className="mt-8 mb-4 z-[10] relative">
                    <a
                      ...
                      } rounded-full bg-white hover:shadow-[2px_2px_0px_0px_#94a3b8] transition-all duration-150`}
                    >
                      {data.linkTitle}
                    </a>
                  </div>
